...
// Create a new div
let rightColumn2 = document.createElement('div');
// Set the style of the div
rightColumn2.style.width = '30%';
rightColumn2.style.height = '100%';
rightColumn2.style.border = '7px solid #bf9864';
rightColumn2.style.backgroundColor = 'black'; // Retain the black background
rightColumn2.style.color = 'lightblue'; // Set the text color to light blue
rightColumn2.style.overflow = 'auto'; // Add scrollbars if the content overflows
rightColumn2.style.position = 'relative';
rightColumn2.style.right = '0'; // Position it on the right
rightColumn2.style.zIndex = '1000'; // Set a higher z-index to ensure it's above other elements



// Create an overlay div for the background image
...
overlay.style.backgroundImage = "url('https://ttalesinteractive.com/graphics/pencil.png')";
overlay.style.backgroundSize = 'cover';
overlay.style.backgroundPosition = 'center';
overlay.style.opacity = '0.10';  // Set the opacity here
overlay.style.zIndex = '-1';  // Place it below the content

// Append the overlay to the main div
rightColumn2.appendChild(overlay);



let warningText = document.createElement('div');
warningText.innerHTML = `
<span style="display: block; text-align: center; font-size: 18px; font-weight: bold; color: #45d4d1;">Welcome to Beta: 1.8.2</span>
<p style="font-size: 14px; color: #45d4d1; margin-left: 10px;">
    2/9: New year, new problems: TTI needs your help! Enjoying the site? Consider 
    <a href="https://www.buymeacoffee.com/elodine" target="_blank" style="color: #45d4d1; text-decoration: underline;">donating to our BuyMeACoffee</a> 
    or 
    <a href="https://www.youtube.com/@elodinecodes" target="_blank" style="color: #45d4d1; text-decoration: underline;">tuning into a livestream</a> 
    to help keep this site going.
</p>

<p style="font-size: 14px; color: #45d4d1; margin-left: 10px;">
    2/9: Models have been adjusted to reflect the recent cost adjustments and releases.
</p>

<p style="font-size: 14px; color: #45d4d1; margin-left: 10px;">Upcoming: A news tab will be added to better track development notes from Turtle and Eli. The prompt and news button will be relocated at this time.'</p>
<img src="https://ttalesinteractive.com/graphics/PageBreakFix.png" alt="Page Break" style="display: block; margin: auto; width: 100%; margin-left: -6px;">

<p style="text-align: center; font-size: 16px; color: #45d4d1; font-weight: bold; text-decoration: underline;">!WARNING!</p>
  <p style="font-size: 14px; color: #45d4d1;  margin-left: 10px;">    By enabling any custom prompt you are acknowledging you are 18 years of age or older. </p>

  <div style="font-size: 12px;">
    <a style="text-decoration: underline; margin-left: 10px; color: lightblue;" href="https://discord.gg/Tr8vvRUuCv" data-type="page" data-id="533">Discord & Bug Reports</a>
	<a style="text-decoration: underline; margin-left: 10px; color: lightblue;" href="https://ttalesinteractive.com/?page_id=1560" data-type="page">Support our Devs</a>
	<a style="text-decoration: underline; margin-left: 10px; color: lightblue;" href="https://ttalesinteractive.com/?page_id=1550" data-type="page" data-id="197">Terms of Service</a>
    <a style="text-decoration: underline; margin-left: 10px; color: lightblue;" href="https://ttalesinteractive.com/?page_id=1552" data-type="page" data-id="193">Privacy Policy</a>

  </div>
`;
warningText.style.position = 'absolute';
warningText.style.bottom ='0%';
warningText.style.left = '0';
warningText.style.width = '100%';
rightColumn2.appendChild(warningText);

// Create the drop-down menu
let narrationDropdown = document.createElement('select');
narrationDropdown.style.position = 'absolute';
narrationDropdown.style.top = '130px';
narrationDropdown.style.left = '10px';
narrationDropdown.title = `Select an option to change the narration mode. Everything is set to a default SFW mode unless otherwise clicked.`;

// Create the options for the drop-down
let option1 = document.createElement('option');
option1.value = 'default';
option1.text = 'Narration: SFW';
narrationDropdown.add(option1);

let option2 = document.createElement('option');
option2.value = 'GPT4';
option2.text = 'SFW GPT4-preview';
narrationDropdown.add(option2);

let option3 = document.createElement('option');
option3.value = 'NSFW';
option3.text = 'Narration: NSFW';
narrationDropdown.add(option3);

// Add the drop-down to the DOM
rightColumn2.appendChild(narrationDropdown);
...
narration_writing_style: HP_Lovecraft, Robert_Heinlein]`;
              ...
              console.log(`No textarea element found with specKey: roleInstruction`);
            }
          }, 500); // delay in ms
...
let dialogueFixButton = document.createElement('button');
dialogueFixButton.style.position = 'absolute'; // Set the position to absolute
dialogueFixButton.style.top = '70px'; // Place it beneath the first button
dialogueFixButton.style.right = '10px';
dialogueFixButton.innerHTML = 'Narration Loop Fix'; // Set the button text
dialogueFixButton.title = `Click this button to end the narration loop.
...
rightColumn2.appendChild(dialogueFixButton); // Add the button to the rightColumn2 div

//Action fix button
let actionFixButton = document.createElement('button');
actionFixButton.style.position = 'absolute'; // Set the position to absolute
actionFixButton.style.top = '100px'; // Place it beneath the first button
actionFixButton.style.right = '10px';
actionFixButton.innerHTML = 'No Action Fix-Enable'; // Set the button text
actionFixButton.title = `Click this button to enable a prompt that will correct an issue where the AI and story become stale.
...
rightColumn2.appendChild(actionFixButton);


// Create a paragraph to display the health
let healthDisplay = document.createElement('p');
healthDisplay.style.position = 'absolute'; // Set the position to absolute
...
// Get the container of the middle column
let container = document.getElementById('middleColumn').parentNode;
// Set the container to display flex
container.style.display = 'flex';
// Append the div to the container
container.appendChild(rightColumn2);
...
// Function to add a CSS class to rightColumn2 for mobile display
function setRightColumn2Display() {
  if (window.innerWidth < 768) { // Adjust the threshold as needed
    rightColumn2.classList.add('mobile-display'); // Add CSS class for mobile display
    rightColumn2.style.display = 'none'; // Hide the rightColumn2 div on mobile
    rightColumn2.style.width = '100%'; // Make the rightColumn2 div take up 100% of the screen width on mobile
    rightColumn2.style.height = '100%'; // Make the rightColumn2 div take up 100% of the screen height on mobile
    rightColumn2.style.position = 'fixed'; // Set the position to fixed on mobile
    rightColumn2.style.top = '0'; // Position it at the top of the screen
    rightColumn2.style.left = '0'; // Position it at the left of the screen
    rightColumn2.style.backgroundColor = 'black'; // Set the background color to black
    rightColumn2.style.zIndex = '1000'; // Set the z-index to 1000 to ensure it's on top of all other elements
  } else {
    rightColumn2.classList.remove('mobile-display'); // Remove CSS class for desktop display
    rightColumn2.style.display = 'block'; // Show the rightColumn2 div on desktop
    rightColumn2.style.width = '30%'; // Reset the width of the rightColumn2 div on desktop
    rightColumn2.style.height = '100%'; // Reset the height of the rightColumn2 div on desktop
    rightColumn2.style.position = 'relative'; // Set the position to relative on desktop
  }
}

// Call the function initially and whenever the window is resized
setRightColumn2Display();
window.addEventListener('resize', setRightColumn2Display);

// Function to toggle the visibility of the rightColumn2 div on mobile
function toggleRightColumn2() {
    if (rightColumn2.style.display === 'none') {
      rightColumn2.style.display = 'block';
    } else {
      rightColumn2.style.display = 'none';
    }
}  
...
buttonImage.src = 'https://ttalesinteractive.com/graphics/newprompt.png'; // Replace with your actual image URL later
buttonImage.width = 60;
...
// Remove image borders and backdrops
buttonImage.style.border = 'none';
buttonImage.style.outline = 'none';
buttonImage.style.boxShadow = 'none';
toggleButton.appendChild(buttonImage);
toggleButton.style.position = 'fixed';
toggleButton.style.top = '10px';
toggleButton.style.right = '9%'; // Added 'px' for proper positioning
toggleButton.style.transform = 'translateX(-50%)';
toggleButton.style.zIndex = '1000'; // Make sure the button is always on top
toggleButton.title = 'Click this button to reveal/hide the prompt screen, custom code, and game stats.';
// Add an event listener to the button to call the toggle function when clicked
toggleButton.addEventListener('click', toggleRightColumn2);
...
style.innerHTML = `
  @media (max-width: 768px) {
    #uniqueToggleButton {
      right: 10px !important; // Move more to the right on mobile
    }
  }
`;
...
let labsButton = document.createElement('button');
labsButton.style.position = 'absolute';
labsButton.style.top = '70px';
labsButton.style.left = '10px';
labsButton.innerHTML = 'Enable Elevenlabs';
labsButton.title = 'Click this button to enable TTS using your Elevenlabs API key.';
  ...
  let checkExist = setInterval(async function() {
    ...
    if (selectedThread) {
      ...
      if (characterEditButton) {
        ...
        setTimeout(function() {
          var textareaElement = document.querySelector('textarea[data-spec-key="customCode"]');
          if (textareaElement !== null) {
            ...
            let similarityBoostValue = prompt("Please enter similarity boost value:", 0);

            // Construct the ElevenLabs code snippet with the new values
            let updatedSnippet = externalJsAsText.replace(/let elevenlabs_token = "[^"]*";/, `let elevenlabs_token = "${tokenID}";`)
                                                 .replace(/let voice_id = "[^"]*";/, `let voice_id = "${voiceId}";`)
                                                 .replace(/let stability = \d+;/, `let stability = ${stabilityValue};`)
                                                 .replace(/let similarity_boost = \d+;/, `let similarity_boost = ${similarityBoostValue};`);

            // Check if ElevenLabs code already exists in the textarea
            if (textareaElement.value.includes("let elevenlabs_token =")) {
              textareaElement.value = textareaElement.value.replace(/let elevenlabs_token =[\s\S]*?let similarity_boost = \d+;/, updatedSnippet.trim());
            } else {
...
rightColumn2.appendChild(labsButton);

let statsButton = document.createElement('button');
statsButton.style.position = 'absolute';
statsButton.style.top = '190px'; // Adjust position as needed
statsButton.style.right = '10px';
statsButton.innerHTML = 'Toggle Stats';
statsButton.title = 'This button will toggle stats on and off.';
          ...
          if (textareaElement !== null) {
            ...
            if (isStatsEnabled) {
              ...
              if (startIndex !== -1 && endIndex !== -1) {
                textareaElement.value = content.substring(0, startIndex) + content.substring(endIndex);
              }
              statsButton.innerHTML = 'Enable Stats';
              isStatsEnabled = false;
            } else {
              // Fetch the stats.txt content
              let statsText = await (await fetch('https://ttalesinteractive.com/beta/oai/stats.txt')).text();
...
rightColumn2.appendChild(statsButton);

//STYLE BUTTON
let textStyleButton = document.createElement('button');
textStyleButton.style.position = 'absolute';
textStyleButton.style.top = '190px'; // Adjust position as needed
textStyleButton.style.left = '10px';
textStyleButton.innerHTML = 'Customize Text';
textStyleButton.title = 'Customize the text style for the AI and yourself.';

textStyleButton.onclick = async function() {
  // User inputs for customization
  let userColor1 = prompt("Enter your preferred overall text color (hex code):", "#66CC33");
  let userColor2 = prompt("Enter your preferred individual message text color (hex code):", "#FFFFFF");
      ...
      if (characterEditButton) {
        ...
        setTimeout(async function() {
          ...
          if (textareaElement !== null) {
            ...
            let textStyleScript = await (await fetch('https://ttalesinteractive.com/beta/oai/textstyle.txt')).text();

            // Replace placeholders with user inputs
            textStyleScript = textStyleScript.replace('/* COLOR */', userColor1);
            textStyleScript = textStyleScript.replace('/* CUSTOM_COLOR_2 */', userColor2);
            textStyleScript = textStyleScript.replaceAll('/* SIZE */', userFontSize + 'px');
            textStyleScript = textStyleScript.replaceAll('/* FONT */', `'${userFontStyle}', sans-serif`);
            ...
            let endIndex = textareaElement.value.indexOf(endMarker) + endMarker.length;
            if (startIndex !== -1 && endIndex !== -1) {
              // Replace old styling
              textareaElement.value = textareaElement.value.substring(0, startIndex) + textStyleScript + textareaElement.value.substring(endIndex);
            } else {
...
rightColumn2.appendChild(textStyleButton);



// Whiskers
let commentatorCode = document.createElement('button');
commentatorCode.style.position = 'absolute';
commentatorCode.style.top = '130px';
commentatorCode.style.right = '10px';
commentatorCode.innerHTML = 'Deploy Whiskers';
commentatorCode.title = 'This button will enable an AI to comment on your adventures.';
...
commentatorCode.onclick = async function() {
  ...
  let externalJsAsText = isCodeEnabled ? "" : await (await fetch('https://ttalesinteractive.com/play/whiskers2.js')).text();
        ...
        setTimeout(function() {
          ...
          if (textareaElement !== null) {
            ...
            if (textareaElement.value.includes(externalJsAsText)) {
              ...
              textareaElement.value = textareaElement.value.replace(externalJsAsText, '');
...
rightColumn2.appendChild(commentatorCode);
...
function showGameInfo() {
  ...
  // Set styles
  document.getElementById('gameInfoImage').style.borderBottom = '7px solid #bf9864';
...
const showGameInfoBtn = document.createElement('button');
showGameInfoBtn.style.position = 'absolute';
showGameInfoBtn.style.top = '40px'; // Place it beneath the first button
showGameInfoBtn.style.left = '10px';
showGameInfoBtn.textContent = 'Show Game Info';
showGameInfoBtn.addEventListener('click', showGameInfo);

const showEncyclopediaBtn = document.createElement('button');
showEncyclopediaBtn.style.position = 'absolute';
showEncyclopediaBtn.style.top = '40px'; // Place it beneath the first button
showEncyclopediaBtn.style.right = '10px';
showEncyclopediaBtn.textContent = 'Show Encyclopedia';
showEncyclopediaBtn.addEventListener('click', showEncyclopedia);

// Append buttons to a container or directly to the body
rightColumn2.appendChild(showGameInfoBtn);
rightColumn2.appendChild(showEncyclopediaBtn);
...
let userDetailButton = document.createElement('button');
userDetailButton.style.position = 'absolute';
userDetailButton.style.top = '100px';
userDetailButton.style.left = '10px';
userDetailButton.innerHTML = '{{user}} details';
userDetailButton.title = `Click me to help the AI remember specific details about your current character.`;


userDetailButton.onclick = async function() {
  // Fetch the external JS file as text
  let response = await fetch('https://ttalesinteractive.com/play/userDetails2.txt');
  let externalJsAsText = await response.text();
  ...
  let checkExist = setInterval(async function() {
    ...
    if (selectedThread) {
      ...
      if (characterEditButton) {
        ...
        setTimeout(function() {
          var textareaElement = document.querySelector('textarea[data-spec-key="roleInstruction"]');
          if (textareaElement !== null) {
            // Prompt for ElevenLabs parameters
...
let updatedSnippet = templateText.replace(/defaultHair/, `${detailHair}`)
...
if (textareaElement.value.includes("{{user}}_details:")) {
  ...
  textareaElement.value = textareaElement.value.replace(/\[ {{user}}_details:[\s\S]*?\]/, updatedSnippet.trim());
} else {
...
rightColumn2.appendChild(userDetailButton);
...
dropdown.style.top = '157px';
dropdown.style.left = '75px';
...
swapButton.textContent = 'Swap to:';

// Style and position the button
swapButton.style.position = 'absolute';
swapButton.style.top = '155px';
swapButton.style.left = '10px'; // Adjust this value as needed

// Append the button to the div
rightColumn2.appendChild(swapButton);
...
function checkForMentions() {
  ...
  for (let i = 0; i < characters.length; i++) {
    const name = characters[i].getElementsByTagName('name')[0].textContent.toLowerCase();
    ...
    if (matches) {
      ...
      if (characterMentions[name] > 1) {
        console.log(`Character Mentioned: ${name}, Count: ${characterMentions[name]}`);
      }
    }
  }
...
function performButtonClickAndUpdate(selectedCharacter, prompt) {
  ...
  let checkExist = setInterval(function() {
	...
	setTimeout(function() {
  const nameInput = document.querySelector('input[data-spec-key="name"]');
  const roleInstructionTextarea = document.querySelector('textarea[data-spec-key="roleInstruction"]');
  ...
  if (nameInput !== null && roleInstructionTextarea !== null) {
    ...
    const userDetailsBlockMatch = existingText.match(/\[\s*\{\{user\}\}_details:.*?\]/s);
    const userDetailsBlock = userDetailsBlockMatch ? userDetailsBlockMatch[0] : '';
    roleInstructionTextarea.value = userDetailsBlock + (userDetailsBlock ? '\n' : '') + prompt;
...
let foresightCode = document.createElement('button');
foresightCode.style.position = 'absolute';
foresightCode.style.top = '160px';
foresightCode.style.right = '10px';
foresightCode.innerHTML = 'Enable Foresight';
foresightCode.title = 'This button will enable the AI to plan things out.';
...
foresightCode.onclick = async function() {
  ...
  let reminderScriptUrl = 'https://ttalesinteractive.com/beta/oai/crystalball.txt';
  let customCodeScriptUrl = 'https://ttalesinteractive.com/beta/oai/crystalball2.txt';

  // Fetch the scripts as text
  let reminderScriptText = isForesightEnabled ? "" : await (await fetch(reminderScriptUrl)).text();
  let customCodeScriptText = isForesightEnabled ? "" : await (await fetch(customCodeScriptUrl)).text();
    ...
    if (selectedThread) {
      ...
      if (characterEditButton) {
        ...
        setTimeout(async function() {
          ...
          var reminderTextArea = document.querySelector('textarea[data-spec-key="reminderMessage"]');
          if (reminderTextArea !== null) {
            reminderTextArea.value = isForesightEnabled ? '' : reminderScriptText;
            toggleButtonLabel();
          } else {
            console.log(`No textarea element found with specKey: reminderMessage`);
          }

          // Update customCode area
          var customCodeTextArea = document.querySelector('textarea[data-spec-key="customCode"]');
